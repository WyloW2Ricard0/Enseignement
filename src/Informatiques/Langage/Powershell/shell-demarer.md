...
Changez le propriétaire du répertoire pour que ce soit vous : `takeown /F PATH_PROJET /R /D Y` puis `icacls "PATH_PROJET"`
- Pour **déplacer un fichier** en ligne de commande (cmd) sous Windows, utilisez la commande move : `move chemin\vers\fichier.ext chemin\vers\nouveau\repertoire\`
