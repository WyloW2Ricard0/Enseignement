...
1. **App Bar :** La barre d’applications supérieure. Il sert à l’image de marque, aux titres d’écran, à la navigation et aux actions.

## Affichage

 - **Timeline :** interface graphique pour visualiser des étapes. Sous forme de ligne verticale, avec des icones ou des *surface* pour chaque événement separer par un tret.